/**
 * Captures d'ecran du catalogue, pour inspection visuelle.
 *   BASE_URL=http://172.20.10.7:3000 node scripts/capture-catalogue.mjs
 */
...
for (const taille of [
  ...
  for (const vue of [
    { chemin: "/vendeur/produits", nom: "catalogue" },
    { chemin: "/vendeur/produits/nouveau", nom: "produit-nouveau" },
    { chemin: "/vendeur/commandes/nouvelle", nom: "commande-nouvelle" },
  ]) {
